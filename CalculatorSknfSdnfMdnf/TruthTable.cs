...
namespace Laba_2_DIS
{
    public class TruthTable
    {
        ...
        public void CreateTableCl(out int countOne)
        {
            countOne = 0;
            ...
            for (int i = 0; i < line; i++)
            {
                ...
                countOne += twoDimArr[i, sizeArr];
            }
        }
        public void CreateTableRnd(out int countOne)
        {
            countOne = 0;
            int line = (int)Math.Pow(2, sizeArr);
            for(int i = 0; i < line; i++)
            {
                ...
                {
                    int powerOfTwo = (int)Math.Pow(2, j);
                    twoDimArr[i, sizeArr - 1 - j] = (i / powerOfTwo) % 2;
                }
            }
            for (int i = 0; i < line; i++)
            {
        ...
        public List<string> GetSkei(List<string> diz)
        {
            List<string> sklei = new List<string>();
            bool[] flagsForSdnf = new bool[diz.Count];
            int count = 0;

            for (int k = 0; k < diz.Count; k++)
            {
                for (int i = k + 1; i < diz.Count; i++)
                {
                    string temp = "";
                    count = 0;
                    string str1 = diz[k];
        ...
        public string NormalPrint(List<string> sklei)
        {
            string str = "-";
            string str1 = "1";
            string mdnf = "";
            foreach(var item in sklei)
            {
